...
namespace StoreFront.Data.Entity
{
    using System;
    ...
    public partial class StoreFrontEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> spLogin(string userName, byte[] password)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
        ...
        public virtual ObjectResult<Nullable<int>> spRegister(string userName, byte[] password, string emailAddress)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("UserName", userName) :
                new ObjectParameter("UserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spRegister", userNameParameter, passwordParameter, emailAddressParameter);
        }
        ...
        public virtual ObjectResult<spUpdateUser_Result> spUpdateUser(Nullable<int> userID, string userName, string emailAddress, Nullable<bool> isAdmin)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
